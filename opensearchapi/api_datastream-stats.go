...
// DataStreamStatsReq represents possible options for the index create request
...
// DataStreamStatsResp represents the returned struct of the index create response
