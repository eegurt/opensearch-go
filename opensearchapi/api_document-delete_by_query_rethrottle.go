...
// DocumentDeleteByQueryRethrottleReq represents possible options for the /_search request
...
// DocumentDeleteByQueryRethrottleResp represents the returned struct of the /_search response
