			...
			Tests: []indicesTests{
				{
					...
					Results: func() (osapitest.Response, error) {
						...
						resp.response, err = client.Indices.Exists(nil, opensearchapi.IndicesExistsReq{Index: []string{index}})
						return resp, err
					},
				},
				{
					...
					Results: func() (osapitest.Response, error) {
						...
						resp.response, err = failingClient.Indices.Exists(nil, opensearchapi.IndicesExistsReq{Index: []string{index}})
						return resp, err
					},
				},
			},
