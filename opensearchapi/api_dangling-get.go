...
// DanglingGetReq represents possible options for the delete dangling request
...
// DanglingGetResp represents the returned struct of the delete dangling response
