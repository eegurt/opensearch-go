...
// DataStreamGetReq represents possible options for the index create request
...
// DataStreamGetResp represents the returned struct of the index create response
