...
// DocumentDeleteByQueryReq represents possible options for the /_search request
...
// DocumentDeleteByQueryResp represents the returned struct of the /_search response
