...
// DataStreamDeleteReq represents possible options for the index create request
...
// DataStreamDeleteResp represents the returned struct of the index create response
