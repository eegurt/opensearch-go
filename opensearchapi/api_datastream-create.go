...
// DataStreamCreateReq represents possible options for the index create request
...
// DataStreamCreateResp represents the returned struct of the index create response
