...
// ClusterPendingTasksReq represents possible options for the /_nodes request
...
// ClusterPendingTasksResp represents the returned struct of the /_nodes response
